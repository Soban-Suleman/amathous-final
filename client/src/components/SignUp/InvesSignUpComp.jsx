...
import InvesModalOne from "../Modal/InvesModalOne";
const InvesSignUpComp = () => {
  return (
    <>
        ...
        <div>
          ...
          <div className="flex justify-center">
            <div className="flex">
              ...
              <button className="rounded-r-lg border border-black bg-black  text-gray-50 py-2 px-9 ">
                Investor
              </button>
            </div>
          </div>
...
export default InvesSignUpComp;
