          ...
          <div className="flex justify-center">
            <div className="flex">
              <Link to="/FounderLoginComp">
                {" "}
                <button className="rounded-l-lg border border-gray-400 text-gray-500 py-2 px-9">
                  Founder
                </button>
              </Link>
              <button className="rounded-r-lg border border-black text-gray-50 py-2 px-9 bg-black">
                Investor
              </button>
            </div>
          </div>
                ...
                <div class="">
                  <div class="relative">
                    <input
                      type="email"
                      id="email"
                      class="bg-gray-200   text-gray-900 text-sm rounded-lg  h-[50px]  block w-full pl-3 p-2.5   "
...
export default InvestLoginComp;
